...
- **Serveur OPC UA** compatible avec la spécification Framatome MSP (namespace `http://framatome.com/UA/msp`)
...
│   ├── Manufacturer           (String) - "Framatome MSP Simulator"
...
│   ├── Description            (String) - Description (ex: "Courant de soudage")
│   ├── ParameterIndex         (UInt32)
│   ├── Enabled                (Boolean) - Paramètre actif ou non
│   ├── Unit                   (String) - Unité de mesure (A, V, °C, etc.)
│   └── Config/
│       └── EngRange/
